/*
** Routine to initialize the parameters for the my map function.
**
**  by Per-Erik Forssén
**
...
*/
   goto mexExit;
mexErrExit:
   mexPrintf("Usage: mysetup(<alpha>, <beta>, <j>);\n");
mexExit: {}
}
