...
{
int ind;
static double M1[3] = {-1.0/3.0, 0.0,    1.0};     /* Red */
static double M2[3] = {1.0,      0.0,   -1.0/3.0}; /* Green */
...
static double temp[3];
   maxi=0.01; /* to avoid division by zero */
   for(x=0;x<xs;x++)
     for(y=0;y<ys;y++) {
       ctens[0]=tens[x*ys+y];
